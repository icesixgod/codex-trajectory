...
The live panel also uses at least 12px text, wraps its controls and Token details in narrow panels, and lets the summary scroll when needed to leave room for the event stream.
